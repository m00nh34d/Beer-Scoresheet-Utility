...
xmlns:wix="http://schemas.microsoft.com/wix/2006/wi">
  ...
  <xsl:key name="service-search" match="wix:Component[wix:File/@Source = 'Scoresheet Reader.exe']" use="@Id" />
  <xsl:key name="service-search" match="wix:Component[wix:File/@Source = 'free3of9.ttf']" use="@Id" />
